          ...
          <header className="sticky top-0 z-50 w-full border-b border-primary-100 bg-white/90 backdrop-blur-sm dark:border-primary-900 dark:bg-primary-950/90">
            <div className="container mx-auto flex h-16 items-center justify-between px-4">
              ...
              <nav className="flex items-center gap-4 md:gap-6">
                ...
                <Link 
                  href="/wallet" 
                  className="text-primary-900 dark:text-primary-100 hover:text-primary-600 dark:hover:text-primary-400 px-3 py-2 rounded-md text-sm font-medium transition-colors"
                >
                  Wallet
                </Link>
                <WalletConnection />
