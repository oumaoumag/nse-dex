                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
                          ...
                          <div>
                            ...
                            <ul className="space-y-4 text-sm">
                              <li><a href="/" className="text-gray-400 hover:text-decode-green transition-colors">Home</a></li>
                              <li><a href="/marketplace" className="text-gray-400 hover:text-decode-green transition-colors">Marketplace</a></li>
                              <li><a href="/trading" className="text-gray-400 hover:text-decode-green transition-colors">P2P Trading</a></li>
                              <li><a href="/wallet" className="text-gray-400 hover:text-decode-green transition-colors">Portfolio</a></li>
                            </ul>
                          </div>
                          <div>
                            <h3 className="text-lg font-bold mb-6 text-decode-white flex items-center">
